...
public class HeroDetailActivity extends AppCompatActivity {
    ...
    private DetailRecyclerViewAdapter mDetailRecyclerViewAdapter;//RecyclerView的Adapter
    ...
    private void initDatas(){
        ...
        switch (mAvatar.getaName()) {
            case "亚巴顿":
                ...
                break;
            case "炼金术师":
                mHeroDetail.add(new HeroDetail(R.mipmap.pixel,"","炼金术师的背景"));
                mHeroDetail.add(new HeroDetail(R.mipmap.abaddon_death_coil_hp1, "死亡缠绕\n" +
                        "（主动）",
                        "以自身生命为祭，通过死亡缠绕伤害/治疗一个敌方/友方单位。\n" +
                                "施法距离：800\n" +
